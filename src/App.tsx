      ...
      <section className="px-4 sm:px-6 lg:px-8 py-24 max-w-7xl mx-auto space-y-32" id="features-detail-section">
        ...
        <motion.div {...fadeIn} className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 w-full">
            <div className="aspect-square md:aspect-[4/3] rounded-[2rem] glass-panel-light dark:glass-panel shadow-2xl flex flex-col p-8 overflow-hidden relative group border border-slate-200/50 dark:border-white/5 justify-center items-center">
        ...
        <motion.div {...fadeIn} className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 w-full">
            <div className="aspect-square md:aspect-[4/3] rounded-[2rem] glass-panel-light dark:glass-panel shadow-2xl flex flex-col p-8 overflow-hidden relative group border border-slate-200/50 dark:border-white/5 justify-center">
              <div className="w-full space-y-4 relative z-10 select-none flex flex-col">
                <div className="self-end bg-[#202425] text-[#e0e0e0] px-4 py-3 rounded-[20px] text-sm font-medium shadow-sm border border-white/5 max-w-[90%]">
                  ci cd sürecindeki hata neydi neler yapmışım
                </div>
                <div className="self-start glass-panel-light dark:glass-panel !bg-[#0f1512] text-slate-200 p-5 rounded-2xl rounded-tl-sm text-sm font-medium w-full shadow-sm border border-emerald-500/30 flex flex-col gap-3">
                  ...
                  <div className="text-sm text-slate-300 leading-relaxed space-y-2 font-medium">
        ...
        <motion.div {...fadeIn} className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 w-full">
            <div className="aspect-square md:aspect-[4/3] rounded-[2rem] glass-panel-light dark:glass-panel shadow-2xl flex flex-col justify-start p-6 overflow-hidden relative group border border-slate-200/50 dark:border-white/5 bg-[#0a0a0a]">
              
              <div className="w-full relative z-10 select-none flex flex-col h-full">
                {/* Breadcrumb */}
                <div className="text-[10px] font-medium text-slate-500 mb-4 flex items-center gap-1.5">
                ...
                {/* Main Toolbar */}
                <div className="flex flex-wrap items-center gap-1 p-1.5 rounded-lg border border-white/10 bg-[#141414] mb-5 w-max">
                ...
                <div className="space-y-4 flex-1">
                  ...
                  <div className="relative mt-2">
                    {/* Floating Toolbar */}
                    <div className="absolute -top-10 left-2 md:left-4 flex items-center gap-1 p-1 rounded-lg border border-white/10 bg-[#1f1f1f] shadow-xl z-20">
                       ...
                       <div className="px-2 py-1 flex items-center gap-1.5 rounded text-emerald-400 text-[10px] font-medium">
                         <Sparkles className="w-3 h-3" /> Yeniden Yaz
                       </div>
                       <div className="px-2 py-1 flex items-center gap-1.5 rounded text-slate-200 text-[10px] font-medium">
                         <HelpCircle className="w-3 h-3" /> Açıkla
                       </div>
                    </div>
                    
                    {/* Highlighted text */}
                    <p className="text-xs md:text-sm text-slate-200 bg-blue-500/30 p-1 -mx-1 rounded leading-relaxed border-b-2 border-blue-500/50 relative z-10">
                  ...
                  <div className="pt-4 border-t border-white/5 mt-4">
                    ...
                    <ul className="space-y-2 text-xs md:text-sm text-slate-300">
                      <li className="flex items-center gap-2"><div className="w-1 h-1 rounded-full bg-slate-500"></div> Günlük standup toplantısına katıl</li>
                      <li className="flex items-center gap-2"><div className="w-1 h-1 rounded-full bg-slate-500"></div> Dashboard latency issue için backend ile follow-up</li>
                      <li className="flex items-center gap-2"><div className="w-1 h-1 rounded-full bg-slate-500"></div> Yeni onboarding flow için metrikleri incele</li>
                    </ul>
                  </div>
                </div>
        ...
        <motion.div {...fadeIn} className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 w-full">
            <div className="aspect-square md:aspect-[4/3] rounded-[2rem] glass-panel-light dark:glass-panel shadow-2xl flex flex-col items-center justify-center p-8 overflow-hidden relative group border border-slate-200/50 dark:border-white/5">
